...
import ru.vaseba.model.x.ucf.UcfCoder;
...
public class Map extends JTable {
    ...
    private final void generateLandscape() {
        ...
        setValueAt(UcfCoder.LANDSCAPE_MOUNTAIN_LOW,  this.mapSize -1, 0 + this.mapSize -1);
    ...
    private static final int getValueAtRange (int value, int max, int min) {
